/*
东东萌宠 更新地址： https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_pet.js
更新时间：2021-01-19
...
[task_local]
#东东萌宠
15 6-18/6 * * * https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_pet.js, tag=东东萌宠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdmc.png, enabled=true

=================================Loon===================================
[Script]
cron "15 6-18/6 * * *" script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_pet.js,tag=东东萌宠

===================================Surge================================
东东萌宠 = type=cron,cronexp="15 6-18/6 * * *",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_pet.js

====================================小火箭=============================
东东萌宠 = type=cron,script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_pet.js, cronexpr="15 6-18/6 * * *", timeout=200, enable=true
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/shuye72/RandomShareCode/master/JD_Pet.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
