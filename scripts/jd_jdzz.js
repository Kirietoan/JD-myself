...
[task_local]
# 京东赚赚
10 0 * * * https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_jdzz.js, tag=京东赚赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzz.png, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_jdzz.js,tag=京东赚赚

===============Surge=================
京东赚赚 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_jdzz.js

============小火箭=========
京东赚赚 = type=cron,script-path=https://raw.githubusercontent.com/shuye72/MyActions/main/scripts/jd_jdzz.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东赚赚');
...
!(async () => {
  $.tuanList = []
  await requireConfig();
  if (helpAuthor) await getAuthorShareCode('https://gitee.com/shuye72/updateTeam/raw/master/jd_zz.json');
  if (helpAuthor) await getAuthorShareCode('https://gitee.com/shuye72/updateTeam/raw/master/jd_zz.json');
  if (!cookiesArr[0]) {
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/shuye72/RandomShareCode/master/JD_Jdzz.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
